...
for k in kList:
    ...
    if(args.quick == 0):
        os.system('magick -delay %f figs/sideStream_%s*.png -colors 256 -depth 256 figs/sideStream_%s.gif' %(500/((maxStep-startStep)/sizeStep), name[k], name[k]))
        if(makeMovie):
