...
% Dimensions of grid
nx=25; % 25 km long
ny=7; % 10 km wide (plus 1 grid walls)
nz=20; % 200 m deep
...
% Iceberg mask
bergMask(2:6,2:end-1) = 1; % icebergs in inner 5 km, all oriented east-west

% Drift mask
driftMask(2:6,2:end-1) = 1; % calculate effect of iceberg drift on melt rates 

% Barrier mask
barrierMask(2:6,2:end-1) = 1; % make icebergs a physical barrier to water flow

% Iceberg concentration (% of each surface cell that is filled in plan view)
bergConc(2:6,2:end-1) = 95; % iceberg concentration is uniformly 10%
