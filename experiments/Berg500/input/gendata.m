...
% Iceberg mask
bergMask(3:12,2:end-1) = 1; % icebergs in inner 5 km, all oriented east-west

% Drift mask
driftMask(3:12,2:end-1) = 1; % calculate effect of iceberg drift on melt rates 

% Barrier mask
barrierMask(3:12,2:end-1) = 1; % make icebergs a physical barrier to water flow

% Iceberg concentration (% of each surface cell that is filled in plan view)
bergConc(3:12,2:end-1) = 95; % iceberg concentration is uniformly 10%
