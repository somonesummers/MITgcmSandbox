...
% Change in boundary conditions from warmest scenario
shift=0;
...
subplot(2,2,1);
axis square
plot(temp,zprof,'color','k','linewidth',2);
...
subplot(2,2,2);
axis square
plot(sal,zprof,'color','k','linewidth',2);
xlabel('Salinity (psu)');
ylabel('Water depth (m)');
set(gca,'YLim',[-500 0]);
set(gca,'XLim',[28 36]);
...
export_fig('idealised_boundary_conditions','-r300','-png');
