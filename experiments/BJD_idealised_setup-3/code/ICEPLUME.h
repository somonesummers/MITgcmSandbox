...
C Parameters relating to the icefront package
     ...
     &     iceplume_TendT,
     &     iceplume_TendS
      _RL iceplume_TendT (1:sNx,1:sNy,Nr,nSx,nSy)
      _RL iceplume_TendS (1:sNx,1:sNy,Nr,nSx,nSy)

      COMMON /ICEPLUME_ICEFRONT_FIELDS_RS/
     &     R_iceplume,
     &     iceplumelength
      _RS R_iceplume     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS iceplumelength (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)

C      LOGICAL ICEFRONTisOn
      LOGICAL applyIceplumeTendT
      LOGICAL applyIceplumeTendS
